"""WildDet3D on Stereo4D-Bench evaluation - box prompt (oracle), with GT depth."""
...
def get_config() -> ExperimentConfig:
    """Returns WildDet3D box prompt (oracle) eval for Stereo4D-Bench with GT depth."""
    config = get_default_cfg(
        exp_name="wilddet3d_stereo4d_box_prompt_with_depth"
    )
