"""WildDet3D on Stereo4D-Bench evaluation - text prompt, with GT depth."""
...
def get_config() -> ExperimentConfig:
    """Returns WildDet3D text eval for Stereo4D-Bench with GT depth."""
    config = get_default_cfg(
        exp_name="wilddet3d_stereo4d_text_with_depth"
    )
