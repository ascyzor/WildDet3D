"""WildDet3D with LingBot-Depth on InTheWild v3 evaluation (2026-03-22).
...
Mode: text prompts, monocular depth (no GT with depth).
"""
...
def get_config() -> ExperimentConfig:
    ...
    config = get_default_cfg(
        exp_name="wilddet3d_lingbot_depth_freeze21_in_the_wild_v3"
    )
