"""WildDet3D with LingBot-Depth on InTheWild v3 - Box prompt eval + GT depth.

Evaluates WildDet3D + LingBot-Depth (freeze21) on InTheWild v3 benchmark
in box_prompt mode: GT 2D boxes as geometry prompts, with GT depth at test time.
Measures pure 3D regression quality with perfect 2D detection and depth.
...
def get_config() -> ExperimentConfig:
    ...
    config = get_default_cfg(
        exp_name="wilddet3d_lingbot_depth_freeze21_in_the_wild_box_prompt_v3_with_depth"
    )
